;(function ($, window, undefined) {
    ...
    $(document).ready(function () { 
        ...
        $(".message-description").slimScroll({
            width: '100%',
            height: 100,
            railVisible: false,
            alwaysVisible: false,
        ...
        $(document).on('click','.btn-del-message',function (e) {
            var _id=$(this).data('id');
            var _this=$(this);
            $.post(_URL+'delMessage',{id:_id},function (data) {
                if(data){
        ...
        $(document).on('click','.btn-edit-message',function (e) {
            ...
            $.each(_input,function () {
                if($(this).attr('name')!='telno'&&$(this).val()==''){
                    toastr.clear();
        ...
        $(document).on('click','.btn-message-new',function (e) {
            $.post(_URL+'newMessage',{id:'new'},function (data) {
                if(data){
                    location.reload();
                }
            });
