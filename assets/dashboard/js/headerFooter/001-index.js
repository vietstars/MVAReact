;(function ($, window, undefined) {
    ...
    $(document).ready(function () { 
        ...
        $(document).on('click','.btn-del-banner',function (e) {
            var _id=$(this).data('id');
            var _this=$(this);
            $.post(_URL+'delScroller',{id:_id},function (data) {
                if(data){
        ...
        $(document).on('click','.btn-edit-banner',function (e) {
            ...
            $.each(_input,function () {
                if($(this).attr('name')!='sorted'&&$(this).val()==''){
                    toastr.clear();
        ...
        $(document).on('click','.btn-banner-new',function (e) {
            $.post(_URL+'newScroller',{id:'new'},function (data) {
                if(data){
                    location.reload();
                }
            });
